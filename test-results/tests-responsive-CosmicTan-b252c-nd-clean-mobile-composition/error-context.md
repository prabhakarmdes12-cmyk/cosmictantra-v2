...
- Name: tests/responsive.spec.ts >> CosmicTantra Mobile Responsiveness & Hardening Suite >> Viewport 430px (430_iphone_pro_max): No horizontal overflow and clean mobile composition
