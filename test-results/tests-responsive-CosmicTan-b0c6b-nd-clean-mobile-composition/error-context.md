...
- Name: tests\responsive.spec.ts >> CosmicTantra Mobile Responsiveness & Hardening Suite >> Viewport 375px (375_iphone_se): No horizontal overflow and clean mobile composition
