...
- Name: tests/responsive.spec.ts >> CosmicTantra Mobile Responsiveness & Hardening Suite >> Viewport 768px (768_ipad_portrait): No horizontal overflow and clean mobile composition
