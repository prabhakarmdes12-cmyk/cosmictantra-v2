...
- Name: tests\responsive.spec.ts >> CosmicTantra Mobile Responsiveness & Hardening Suite >> Viewport 412px (412_pixel_samsung): No horizontal overflow and clean mobile composition
