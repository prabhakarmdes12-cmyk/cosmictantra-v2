...
- Name: tests\responsive.spec.ts >> CosmicTantra Mobile Responsiveness & Hardening Suite >> Mobile Drawer opens and navigates cleanly at 320px
- Location: tests\responsive.spec.ts:80:7
...
Locator: locator('button[aria-label="Open navigation menu"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button[aria-label="Open navigation menu"]')
