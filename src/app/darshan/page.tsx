...
const JYOTIRLINGA_DATA: ShrineItem[] = [
  ...
  },
  {
    ...
    videoId: 'Xd91XgQyjCg',
    liveUrl: 'https://www.youtube.com/watch?v=Xd91XgQyjCg',
  ...
  },
  {
    ...
    videoId: 'R07P7d2zTXU',
    liveUrl: 'https://www.youtube.com/watch?v=R07P7d2zTXU',
...
const SIDDHA_STUTI_DATA: ShrineItem[] = [
  {
    id: 'siddha-1',
    order: 1,
    name: '1. Mangal Geet (Kavi Jayadeva | Swami Nigrahacharya)',
    nameHi: '१. मंगल गीत (कवि जयदेव • स्वामी निग्रहाचार्य)',
    deity: 'Bhagavan Shri Hari Krishna',
    deityHi: 'माङ्गल्य मङ्गलकर भगवान श्रीकृष्ण',
    location: 'Shri Jagannath Puri & Braj Dham',
    locationHi: 'श्री जगन्नाथ पुरी व पावन ब्रज धाम',
    state: 'Sanatan Teerth',
    category: 'SIDDHA_STUTI',
    shloka: 'माङ्गल्यमङ्गलकरं प्रणमामि कृष्णम् । कलितललितवनमाल जय जय देव हरे ॥',
    shlokaMeaning: 'समस्त मंगलों के परम मंगलकर्ता कमलनयन भगवान श्रीकृष्ण को मेरा बारम्बार प्रणाम है।',
    angaOrSignificance: 'महाकवि जयदेव रचित परम पावन मंगल गीत — पूज्य स्वामी निग्रहाचार्य जी महाराज द्वारा मुखरित अलौकिक गान। (#mangalgeet #kavijayadeva #nigrahacharya)',
    bhairavOrLord: 'श्री जगन्नाथ महाप्रभु',
    imageUrl: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&w=1400&q=85',
    videoId: 'GfuMCzUmC4g',
    liveUrl: 'https://www.youtube.com/watch?v=GfuMCzUmC4g',
    trustUrl: 'https://www.youtube.com/@SwamiNigrahacharya',
    helpline: 'Toll Free: 1800 2026 888',
    mapQuery: 'Jagannath Puri Odisha',
    timingsHi: 'प्रातः माङ्गलिक वन्दन एवं नित्य भजन',
    color: '#D97706'
  },
  {
    id: 'siddha-2',
    order: 2,
    name: '2. Hiremath Ji Maharaj Shiva Stotra',
    nameHi: '२. पूज्य हीरेमठ जी महाराज शिव स्तोत्र',
  ...
  },
  {
    id: 'siddha-3',
    order: 3,
    name: '3. Radhe Radhe Barsane Wali Radhe (84 Kos Yatra)',
    nameHi: '३. राधे राधे बरसाने वाली राधे (८४ कोस यात्रा)',
...
export default function DarshanPage() {
  ...
  // Listen for fullscreen change events & global Escape key
  useEffect(() => {
            ...
            <div className="relative group h-full">
              ...
              <div 
                ...
                className={`relative bg-[#05060A] rounded-3xl border border-[#8E6F1D]/40 shadow-2xl overflow-hidden flex flex-col justify-between transition-all h-full ${
                  isFullscreen ? 'fixed inset-0 z-[9999] rounded-none border-none h-screen w-screen max-h-screen bg-black' : 'min-h-[460px] sm:min-h-[520px] lg:min-h-[560px]'
                } ${
                  hasLitDiya ? 'ring-2 ring-amber-400/90 shadow-[inset_0_0_60px_rgba(245,158,11,0.5),0_0_40px_rgba(251,191,36,0.65)]' : ''
                }`}
              >
                {/* Dedicated High-Visibility Floating Exit Fullscreen Button */}
                {isFullscreen && (
                  <button
                    onClick={handleExitFullscreen}
                    className="fixed top-4 right-4 z-[99999] px-4 py-2 rounded-full bg-black/90 hover:bg-red-600 text-white text-xs font-mono-data font-bold border-2 border-amber-400/80 hover:border-red-400 flex items-center gap-2 shadow-2xl transition-all cursor-pointer hover:scale-105 active:scale-95"
                    title="Exit Fullscreen (Esc)"
                  >
                    <X className="w-4 h-4 text-amber-300" />
                    <span>फुलस्क्रीन बन्द करें [Esc]</span>
                  </button>
                )}
                ...
                <div className="absolute top-0 inset-x-0 z-30 p-2.5 sm:p-4 bg-gradient-to-b from-black/95 via-black/70 to-transparent flex items-center justify-between gap-2 text-white">
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h2 className="font-editorial font-bold text-sm sm:text-base text-white leading-none truncate">
                        {activeShrine.nameHi}
                      </h2>
                      <span className="text-[10px] font-mono-data text-[#D1C9BF] hidden sm:inline truncate">
