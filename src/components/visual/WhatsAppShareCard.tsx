...
export default function WhatsAppShareCard({
  ...
  return (
    <div className="relative w-full max-w-[360px] mx-auto aspect-[9/16] bg-gradient-to-b from-[#FAF7F2] to-[#F5EEDC] border border-[#8E6F1D]/30 rounded-3xl overflow-hidden shadow-2xl flex flex-col">
      {/* Header */}
