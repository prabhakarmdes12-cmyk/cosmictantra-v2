...
export const TEMPLATES_HI: Record<string, string> = {
  ...
  'CAREER_ARTHA_TRIKONA': 'अर्थ त्रिकोण {{houses}} के स्वामी {{lords}} हैं; {{occupancy}}',
  ...
  'CAREER_ACTIVATION_NONE': '{{level}} स्वामी {{lord}} किसी भी अर्थ भाव ({{arthas}}) को स्थिति, स्वामित्व या पूर्ण दृष्टि से स्पर्श नहीं करता।',
