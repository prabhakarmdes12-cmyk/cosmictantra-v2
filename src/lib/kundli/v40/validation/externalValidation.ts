...
export const GOLDEN_VALIDATION_REGISTER: ExternalValidationCase[] = [
  ...
  pending('EV-13', 'VIMSHOTTARI_BOUNDARY', 'Balance of Sun mahadasha at birth', '5y 0m 4d', 5.012356, 1, 'DAYS', ''),
  pending('EV-14', 'VIMSHOTTARI_BOUNDARY', 'Rahu mahadasha start', '2017-06-19', undefined, 1, 'DAYS',
