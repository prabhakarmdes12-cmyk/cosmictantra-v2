...
- [`EVIDENCE_OBSERVATION_V1.md`](EVIDENCE_OBSERVATION_V1.md) — implementation note for the display-only viewport, observation helpers, Student Desk, synchronized Study Cockpit, versioned snapshot/provenance workflow, file map, validation record, and remaining qualification guardrails.
