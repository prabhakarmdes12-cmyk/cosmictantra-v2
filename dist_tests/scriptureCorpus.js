...
exports.VERIFIED_SCRIPTURE_CORPUS = void 0;
exports.validateAndRetrieveScripture = validateAndRetrieveScripture;
exports.VERIFIED_SCRIPTURE_CORPUS = {
    'BG_2_47': {
...
function validateAndRetrieveScripture(grantha, chapter, verse) {
    ...
    if (grantha.toLowerCase().includes('gita') || grantha.includes('गीता')) {
        ...
        if (exports.VERIFIED_SCRIPTURE_CORPUS[key]) {
            return { isValid: true, entry: exports.VERIFIED_SCRIPTURE_CORPUS[key] };
        }
        return {
            isValid: true,
            entry: {
